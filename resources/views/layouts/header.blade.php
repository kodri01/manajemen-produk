...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item <?php if ($title == 'Product - Stok Barang' || $title == 'Product - Barang Masuk' || $title == 'Product - Purchase Order' || $title == 'Product - Details Order' || $title == 'Product - Barang Keluar') {
                    ...
                    <div class="collapse <?php if ($title == 'Product - Stok Barang' || $title == 'Product - Barang Masuk' || $title == 'Product - Purchase Order' || $title == 'Product - Details Order' || $title == 'Product - Barang Keluar') {
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item <?php if ($title == 'Product - Stok Barang') {
                                echo 'active';
                            ...
                            <a class="collapse-item <?php if ($title == 'Product - Barang Keluar') {
                                ...
                                Keluar</a>
                            <a class="collapse-item <?php if ($title == 'Product - Purchase Order' || $title == 'Product - Details Order') {
                                echo 'active';
            ...
            @role(['administrator', 'produksi'])
                <li class="nav-item <?php if ($title == 'Produksi - Data Resep' || $title == 'Produksi - Details Resep' || $title == 'Produksi - Persedian Barang') {
                    echo 'active';
                } ?>">
            ...
            @endrole
            @role('administrator')
                <li class="nav-item <?php if ($title == 'Supplier - Data Supplier') {
                    echo 'active';
                } ?>">
                    ...
                    <div class="collapse <?php if ($title == 'Supplier - Data Supplier') {
                        echo 'show';
                    } ?>" id="collapseOne" aria-labelledby="headingOne"
                        data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item <?php if ($title == 'Supplier - Data Supplier') {
                                echo 'active';
                            } ?>" href="{{ route('supplier') }}">Data Supplier</a>
                        </div>
                    </div>
                </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                @if (Auth::user()->profile == null)
                                    ...
                                    @endif
                                @else
                                    <img alt="image" src="{{ url('uploads/' . Auth::user()->profile) }}"
                                        class="img-profile rounded-circle">
                                @endif
                            </a>
